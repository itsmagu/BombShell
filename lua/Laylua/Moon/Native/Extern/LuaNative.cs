...
using Laylua.Moon.Native.Laylua;
using Laylua.Moon.Native.Marshaling;
using Laylua.Moon.Native.Structures;

namespace Laylua.Moon.Native.Extern;
...
public static unsafe partial class LuaNative
{
    ...
    {
        var wrapperPtr = Laylua.LayluaNative.CreateLuaCFunctionWrapper(fn);
#if TRACE_PANIC
