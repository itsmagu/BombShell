...
using Laylua.Moon.Allocator;
using Laylua.Moon.Hook;
...
public unsafe class LuaState : IDisposable, ISpanFormattable
{
    ...
    private void ValidateCtor()
    {
        ...
        var panicPtr = Native.Laylua.LayluaNative.InitializePanic();
    ...
    internal LuaHookFunction WrapHookFunction(LuaHook hook)
    {
        ...
        _safeHookFunction = Marshal.GetDelegateForFunctionPointer<LuaHookFunction>(Native.Laylua.LayluaNative.CreateLuaHookFunctionWrapper(_innerHookFunction));
