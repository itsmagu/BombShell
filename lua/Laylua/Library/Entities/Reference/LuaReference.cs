...
using Laylua.Library.Extensions.Internal;
using Laylua.Library.Marshaler;
using Laylua.Moon;
using Laylua.Moon.Enums;
using Laylua.Moon.Native.Structures;

namespace Laylua.Library.Entities.Reference;
...
{
    /// <summary>
    ///     Gets the <see cref="Library.Lua"/> instance this object is bound to.
    /// </summary>
    public Lua Lua
    {
        get
