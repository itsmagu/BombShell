...
public class TypeMemberProvider
{
    ...
    public virtual IEnumerable<PropertyInfo> EnumerateReadableProperties(System.Type type, bool isTypeDefinition)
    {
    ...
    public virtual IEnumerable<PropertyInfo> EnumerateWritableProperties(System.Type type, bool isTypeDefinition)
    {
        var bindingFlags = BindingFlags.Public | BindingFlags.NonPublic | (isTypeDefinition ? BindingFlags.Static : BindingFlags.Instance);
        var properties = type.GetProperties(bindingFlags);
        foreach (var property in properties)
    ...
    public virtual IEnumerable<FieldInfo> EnumerateFields(System.Type type, bool isTypeDefinition)
    {
        var bindingFlags = BindingFlags.Public | BindingFlags.NonPublic | (isTypeDefinition ? BindingFlags.Static : BindingFlags.Instance);
    ...
    public virtual IEnumerable<MethodInfo> EnumerateMethods(System.Type type, bool isTypeDefinition)
    {
        var bindingFlags = BindingFlags.Public | BindingFlags.NonPublic | (isTypeDefinition ? BindingFlags.Static : BindingFlags.Instance);
