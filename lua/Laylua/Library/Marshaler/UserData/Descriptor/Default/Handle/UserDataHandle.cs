...
using Qommon;
using LayluaNative = Laylua.Moon.Native.Laylua.LayluaNative;

namespace Laylua.Library.Marshaler.UserData.Descriptor.Default.Handle;
...
public unsafe class UserDataHandle
{
    ...
    /// </summary>
    public virtual bool TryGetType([MaybeNullWhen(false)] out System.Type type)
    {
        type = default;
        return false;
    }
